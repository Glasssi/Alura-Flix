...
export default function BannerVideo() {
  ...
  return (
    <div className="w-full aspect-video rounded-lg boxShadow shadow-indigo-600 border-20 overflow-hidden  transition-transform hover:scale-105 shadow-2xl"
     >
      <a
        href={videoUrl}
      ...
      >
        <img 
          ...
          style={{ 
            border: '2px solid rgba(110, 80, 241, 0.95)',
            boxShadow: '12px 20px 40px rgb(197, 106, 193)'
          }}
        />
